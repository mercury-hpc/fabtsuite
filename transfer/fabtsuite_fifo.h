 ...
 * position.
 */
bufhdr_t *fifo_alt_get(fifo_t *f);
 ...
 * position.
 */
bool fifo_alt_put(fifo_t *f, bufhdr_t *h);
 ...
 */
bool fifo_put(fifo_t *f, bufhdr_t *h);

void fifo_cancel(struct fid_ep *ep, fifo_t *posted);
