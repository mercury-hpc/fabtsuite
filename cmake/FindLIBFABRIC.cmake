...
if(NOT (PC_LIBFABRIC_FOUND STREQUAL "IGNORE"))
  ...
  if(PKG_CONFIG_FOUND)
    ...
    pkg_check_modules(PC_LIBFABRIC libfabric>=1.11)
    ...
    if(PC_LIBFABRIC_FOUND)
      ...
      # This doesn't work with Spack's libfabric.
      # set(LIBFABRIC_LIBRARIES ${PC_LIBFABRIC${_PC_TYPE}_LINK_LIBRARIES})
      set(LIBFABRIC_LIBRARIES ${PC_LIBFABRIC${_PC_TYPE}_LIBRARIES})
...
if(LIBFABRIC_FOUND)
  ...
  message (FATAL_ERROR "Could not find a suitable version of libfabric (>=1.11)")
endif()
